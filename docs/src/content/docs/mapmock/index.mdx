...
## Map Rule
The first step is creating a new **Map Rule** by clicking the **+Add** button . There are two types of Map Rule:
...
### 1. Map Locale
Let's take an example to learn Map Local. The example URL is https://demo.echolabx.com/. It's default response:  
